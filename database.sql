...
CREATE TABLE Users(UserID INT NOT NULL AUTO_INCREMENT, FirstName VARCHAR(35), LastName VARCHAR(35), Age INT, Gender VARCHAR(20), CONSTRAINT PRIMARY KEY(UserID));

ALTER TABLE Users AUTO_INCREMENT=1111;

CREATE INDEX indexU ON Users(FirstName,LastName);
