	...
	<body>
		...
		<div class="surveyPage">
			...
			<form action="pre_page2.php" method="post" id="prepage1">
				...
				<label for="q1-a2">Rarely</label><br><br>
				
				<input type="radio" value="Sometimes" id="q1-a3" name="q1">
				<label for="q1-a3">Sometimes</label><br><br>
				...
				<label for="q2-a2">Rarely</label><br><br>
				
				<input type="radio" value="Sometimes" id="q2-a3" name="q2">
				<label for="q2-a3">Sometimes</label><br><br>
				...
				<label for="q3-a2">Rarely</label><br><br>
				
				<input type="radio" value="Sometimes" id="q3-a3" name="q3">
				<label for="q3-a3">Sometimes</label><br><br>	
				...
				<label for="q4-a2">Rarely</label><br><br>
				
				<input type="radio" value="Sometimes" id="q4-a3" name="q4">
				<label for="q4-a3">Sometimes</label><br><br>	
				...
				<label for="q5-a2">Rarely</label><br><br>
				
				<input type="radio" value="Sometimes" id="q5-a3" name="q5">
				<label for="q5-a3">Sometimes</label><br><br>	
